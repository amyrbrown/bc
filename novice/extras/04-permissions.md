...
title: Permissions
---
The Unix operating system protects files using 
*permissions*. Permissions determine who can **see** the contents of a files,
who can **change** those files,
and who can **run** particular programs (which are just a special kind of file).
...
<!-- FIXME is the next sentence necessary? -->
...
Next to that is the name of the group that owns it,
...
which isn't particularly memorable.)
...
<!-- FIXME I notice there's nothing here about *how* to change permissions on
Windows. Maybe at least we can suggest a search engine string? -->
